...
void Scene::Create()
{
	...
	WorldLine* wrdln = new GeodeticLine(vec3(0.0f, 0.0f, 0.0f), vec3(0.4f, 0.0f, 0.0f), "Obs1's world line");
	...
	wrdln = new GeodeticLine(vec3(3.0f, -20.0f, 0.0f), vec3(0.4f, 0.2f, 0.0f), "Obj1's world line");
