...
If we ignore the path travelled by photons towards the eye of the viewer, than simultaneous events can be seen. This way the length contraction is observable as shown in Figure~\ref{fig:lengthContraction}.
...
\section{Conclusions}
\label{sec:concl}
The simulator application described in this article is capable of visualising of well known relativistic phenomena.


\section*{Acknowledgements}
I would like to thank Dr. Bokor Nándor and Dr. Szirmay Kalos László for their technical assistance and support.
